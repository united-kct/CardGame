...
namespace Generated.MasterData
{
   public sealed class MemoryDatabase : MemoryDatabaseBase
   {
        ...
        {
            this.CardTable = ExtractTableData<Card, CardTable>(header, databaseBinary, options, xs => new CardTable(xs));
        }
        ...
        public DatabaseBuilder ToDatabaseBuilder()
        {
            ...
            builder.Append(this.CardTable.GetRawDataUnsafe());
            return builder;
        }
        ...
        public ValidateResult Validate()
        {
            ...
            ((ITableUniqueValidate)CardTable).ValidateUnique(result);
            ValidateTable(CardTable.All, database, "Id", CardTable.PrimaryKeySelector, result);
        ...
        public static MasterMemory.Meta.MetaDatabase GetMetaDatabase()
        {
            ...
            dict.Add("card", Generated.MasterData.Tables.CardTable.CreateMetaTable());
